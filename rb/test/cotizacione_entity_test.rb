...
class CotizacioneEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DOLARYMONEDAS_TEST_COTIZACIONE_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def cotizacione_basic_setup(extra)
  ...
  entid_env_raw = ENV["DOLARYMONEDAS_TEST_COTIZACIONE_ENTID"]
