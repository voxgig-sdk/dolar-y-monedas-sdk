...
#      offline in seeded test mode (DolarYMonedasSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "DolarYMonedas_sdk.rb")
  SDK_CLASS = "DolarYMonedasSDK"
