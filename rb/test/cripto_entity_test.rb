...
class CriptoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DOLAR_Y_MONEDAS_TEST_CRIPTO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def cripto_basic_setup(extra)
  ...
  entid_env_raw = ENV["DOLAR_Y_MONEDAS_TEST_CRIPTO_ENTID"]
