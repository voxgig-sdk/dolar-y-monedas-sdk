...
class CotizacionAmbitoEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set DOLARYMONEDAS_TEST_COTIZACION_AMBITO_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def cotizacion_ambito_basic_setup(extra)
  ...
  entid_env_raw = ENV["DOLARYMONEDAS_TEST_COTIZACION_AMBITO_ENTID"]
