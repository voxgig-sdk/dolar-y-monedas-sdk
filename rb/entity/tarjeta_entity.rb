...
class TarjetaEntity
  ...
  def make
    opts = @_entopts.dup
    TarjetaEntity.new(@_client, opts)
  end
  ...
  # @return [Tarjeta, Hash] the current Tarjeta data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Tarjeta fields)
  def match_get
  ...
  #
  # @param reqmatch [TarjetaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Tarjeta.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Tarjeta, Hash] the loaded Tarjeta; raises DolarYMonedasError on failure
