...
class CotizacioneEntity
  ...
  def make
    opts = @_entopts.dup
    CotizacioneEntity.new(@_client, opts)
  end
  ...
  # @return [Cotizacione, Hash] the current Cotizacione data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Cotizacione fields)
  def match_get
  ...
  #
  # @param reqmatch [CotizacioneListMatch, Hash, nil] match filter (any subset of
  #   Cotizacione fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Cotizacione>, Array] the matching Cotizacione items; raises DolarYMonedasError on failure
