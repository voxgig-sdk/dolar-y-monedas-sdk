...
class UyuEntity
  ...
  # @return [Uyu, Hash] the current Uyu data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Uyu fields)
  def match_get
  ...
  # Load a single Uyu.
  #
  # @param reqmatch [UyuLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Uyu.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Uyu, Hash] the loaded Uyu; raises DolarYMonedasError on failure
