...
class DolareEntity
  ...
  # @return [Dolare, Hash] the current Dolare data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Dolare fields)
  def match_get
  ...
  #
  # @param reqmatch [DolareListMatch, Hash, nil] match filter (any subset of
  #   Dolare fields); defaults to nil, treated as an empty match that lists all.
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Dolare>, Array] the matching Dolare items; raises DolarYMonedasError on failure
