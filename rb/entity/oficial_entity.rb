...
class OficialEntity
  ...
  def make
    opts = @_entopts.dup
    OficialEntity.new(@_client, opts)
  end
  ...
  # @return [Oficial, Hash] the current Oficial data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Oficial fields)
  def match_get
  ...
  #
  # @param reqmatch [OficialLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Oficial.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Oficial, Hash] the loaded Oficial; raises DolarYMonedasError on failure
