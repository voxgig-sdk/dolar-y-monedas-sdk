...
class BolsaEntity
  ...
  # @return [Bolsa, Hash] the current Bolsa data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Bolsa fields)
  def match_get
  ...
  # Load a single Bolsa.
  #
  # @param reqmatch [BolsaLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Bolsa.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Bolsa, Hash] the loaded Bolsa; raises DolarYMonedasError on failure
