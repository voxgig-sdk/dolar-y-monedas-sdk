...
class BrlEntity
  ...
  # @return [Brl, Hash] the current Brl data
  def data_get
  ...
  # @return [Hash] the current match filter (any subset of Brl fields)
  def match_get
  ...
  # Load a single Brl.
  #
  # @param reqmatch [BrlLoadMatch, Hash, nil] match criteria (id/query fields);
  #   optional — an entity with no id-like key loads with no match (nil is treated
  #   as an empty match, so client.Brl.load works with no args).
  # @param ctrl [Object, nil] optional per-call control
  # @return [Brl, Hash] the loaded Brl; raises DolarYMonedasError on failure
