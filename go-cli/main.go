// Command DolarYMonedas-cli is a CLI + REPL for the DolarYMonedas SDK,
...
const prompt = "dolar-y-monedas"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "blue bolsa brl clp contadoconliqui cotizacion_ambito cotizacione cripto dolare estado eur mayorista oficial tarjeta uyu"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      DOLAR_Y_MONEDAS_APIKEY (api key), DOLAR_Y_MONEDAS_BASE (base url override)")
