...
func registerSDKWords(r *eng.Registry, client *sdk.DolarYMonedasSDK) {
...
func runOp(client *sdk.DolarYMonedasSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
