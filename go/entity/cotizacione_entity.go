...
func NewCotizacioneEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *CotizacioneEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CotizacioneEntity) GetName() string { return e.name }
...
func (e *CotizacioneEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CotizacioneEntity) Deleted() bool {
	return e.deleted
}


func (e *CotizacioneEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCotizacioneEntity(e.client, opts)
}

func (e *CotizacioneEntity) Data(args ...any) any {
...
func (e *CotizacioneEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cotizacione; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CotizacioneEntity) DataTyped(data ...Cotizacione) Cotizacione {
	if len(data) > 0 {
		return typedFrom[Cotizacione](e.Data(asMap(data[0])))
	}
	return typedFrom[Cotizacione](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cotizacione (all fields
// optional at the wire level).
func (e *CotizacioneEntity) MatchTyped(match ...Cotizacione) Cotizacione {
	if len(match) > 0 {
		return typedFrom[Cotizacione](e.Match(asMap(match[0])))
	}
	return typedFrom[Cotizacione](e.Match())
}
...
func (e *CotizacioneEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CotizacioneEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}



func (e *CotizacioneEntity) List(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CotizacioneListMatch and returns []Cotizacione. It delegates to the untyped
// List (identical runtime) and converts at the typed boundary.
func (e *CotizacioneEntity) ListTyped(reqmatch CotizacioneListMatch, ctrl map[string]any) ([]Cotizacione, error) {
	res, err := e.List(asMap(reqmatch), ctrl)
	if err != nil {
		return nil, err
	}
	return typedSliceFrom[Cotizacione](res), nil
}



func (e *CotizacioneEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CotizacioneEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CotizacioneEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CotizacioneEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
