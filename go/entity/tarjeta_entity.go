...
func NewTarjetaEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *TarjetaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *TarjetaEntity) GetName() string { return e.name }
...
func (e *TarjetaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *TarjetaEntity) Deleted() bool {
	return e.deleted
}


func (e *TarjetaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewTarjetaEntity(e.client, opts)
}

func (e *TarjetaEntity) Data(args ...any) any {
...
func (e *TarjetaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Tarjeta; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *TarjetaEntity) DataTyped(data ...Tarjeta) Tarjeta {
	if len(data) > 0 {
		return typedFrom[Tarjeta](e.Data(asMap(data[0])))
	}
	return typedFrom[Tarjeta](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Tarjeta (all fields
// optional at the wire level).
func (e *TarjetaEntity) MatchTyped(match ...Tarjeta) Tarjeta {
	if len(match) > 0 {
		return typedFrom[Tarjeta](e.Match(asMap(match[0])))
	}
	return typedFrom[Tarjeta](e.Match())
}
...
func (e *TarjetaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *TarjetaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// TarjetaLoadMatch and returns an Tarjeta. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *TarjetaEntity) LoadTyped(reqmatch TarjetaLoadMatch, ctrl map[string]any) (Tarjeta, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Tarjeta{}, err
	}
	return typedFrom[Tarjeta](res), nil
}



func (e *TarjetaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *TarjetaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *TarjetaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *TarjetaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *TarjetaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
