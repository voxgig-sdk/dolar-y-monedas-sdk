...
type ContadoconliquiEntity struct {
	name    string
...
func NewContadoconliquiEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *ContadoconliquiEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ContadoconliquiEntity) GetName() string { return e.name }
...
func (e *ContadoconliquiEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ContadoconliquiEntity) Deleted() bool {
	return e.deleted
}


func (e *ContadoconliquiEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewContadoconliquiEntity(e.client, opts)
}

func (e *ContadoconliquiEntity) Data(args ...any) any {
...
func (e *ContadoconliquiEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Contadoconliqui; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ContadoconliquiEntity) DataTyped(data ...Contadoconliqui) Contadoconliqui {
	if len(data) > 0 {
		return typedFrom[Contadoconliqui](e.Data(asMap(data[0])))
	}
	return typedFrom[Contadoconliqui](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Contadoconliqui (all fields
// optional at the wire level).
func (e *ContadoconliquiEntity) MatchTyped(match ...Contadoconliqui) Contadoconliqui {
	if len(match) > 0 {
		return typedFrom[Contadoconliqui](e.Match(asMap(match[0])))
	}
	return typedFrom[Contadoconliqui](e.Match())
}
...
func (e *ContadoconliquiEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ContadoconliquiEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ContadoconliquiLoadMatch and returns an Contadoconliqui. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ContadoconliquiEntity) LoadTyped(reqmatch ContadoconliquiLoadMatch, ctrl map[string]any) (Contadoconliqui, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Contadoconliqui{}, err
	}
	return typedFrom[Contadoconliqui](res), nil
}



func (e *ContadoconliquiEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ContadoconliquiEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ContadoconliquiEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ContadoconliquiEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ContadoconliquiEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
