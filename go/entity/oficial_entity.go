...
func NewOficialEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *OficialEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *OficialEntity) GetName() string { return e.name }
...
func (e *OficialEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *OficialEntity) Deleted() bool {
	return e.deleted
}


func (e *OficialEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewOficialEntity(e.client, opts)
}

func (e *OficialEntity) Data(args ...any) any {
...
func (e *OficialEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Oficial; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *OficialEntity) DataTyped(data ...Oficial) Oficial {
	if len(data) > 0 {
		return typedFrom[Oficial](e.Data(asMap(data[0])))
	}
	return typedFrom[Oficial](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Oficial (all fields
// optional at the wire level).
func (e *OficialEntity) MatchTyped(match ...Oficial) Oficial {
	if len(match) > 0 {
		return typedFrom[Oficial](e.Match(asMap(match[0])))
	}
	return typedFrom[Oficial](e.Match())
}
...
func (e *OficialEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *OficialEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// OficialLoadMatch and returns an Oficial. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *OficialEntity) LoadTyped(reqmatch OficialLoadMatch, ctrl map[string]any) (Oficial, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Oficial{}, err
	}
	return typedFrom[Oficial](res), nil
}



func (e *OficialEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *OficialEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *OficialEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *OficialEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *OficialEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
