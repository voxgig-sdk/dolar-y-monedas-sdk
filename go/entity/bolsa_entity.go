...
func NewBolsaEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *BolsaEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BolsaEntity) GetName() string { return e.name }
...
func (e *BolsaEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BolsaEntity) Deleted() bool {
	return e.deleted
}


func (e *BolsaEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBolsaEntity(e.client, opts)
}

func (e *BolsaEntity) Data(args ...any) any {
...
func (e *BolsaEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Bolsa; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BolsaEntity) DataTyped(data ...Bolsa) Bolsa {
	if len(data) > 0 {
		return typedFrom[Bolsa](e.Data(asMap(data[0])))
	}
	return typedFrom[Bolsa](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Bolsa (all fields
// optional at the wire level).
func (e *BolsaEntity) MatchTyped(match ...Bolsa) Bolsa {
	if len(match) > 0 {
		return typedFrom[Bolsa](e.Match(asMap(match[0])))
	}
	return typedFrom[Bolsa](e.Match())
}
...
func (e *BolsaEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BolsaEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BolsaLoadMatch and returns an Bolsa. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BolsaEntity) LoadTyped(reqmatch BolsaLoadMatch, ctrl map[string]any) (Bolsa, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Bolsa{}, err
	}
	return typedFrom[Bolsa](res), nil
}



func (e *BolsaEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BolsaEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BolsaEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BolsaEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BolsaEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
