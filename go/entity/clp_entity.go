...
func NewClpEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *ClpEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ClpEntity) GetName() string { return e.name }
...
func (e *ClpEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *ClpEntity) Deleted() bool {
	return e.deleted
}


func (e *ClpEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewClpEntity(e.client, opts)
}

func (e *ClpEntity) Data(args ...any) any {
...
func (e *ClpEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Clp; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *ClpEntity) DataTyped(data ...Clp) Clp {
	if len(data) > 0 {
		return typedFrom[Clp](e.Data(asMap(data[0])))
	}
	return typedFrom[Clp](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Clp (all fields
// optional at the wire level).
func (e *ClpEntity) MatchTyped(match ...Clp) Clp {
	if len(match) > 0 {
		return typedFrom[Clp](e.Match(asMap(match[0])))
	}
	return typedFrom[Clp](e.Match())
}
...
func (e *ClpEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *ClpEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// ClpLoadMatch and returns an Clp. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *ClpEntity) LoadTyped(reqmatch ClpLoadMatch, ctrl map[string]any) (Clp, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Clp{}, err
	}
	return typedFrom[Clp](res), nil
}



func (e *ClpEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *ClpEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *ClpEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *ClpEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *ClpEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
