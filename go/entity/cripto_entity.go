...
func NewCriptoEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *CriptoEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *CriptoEntity) GetName() string { return e.name }
...
func (e *CriptoEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *CriptoEntity) Deleted() bool {
	return e.deleted
}


func (e *CriptoEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewCriptoEntity(e.client, opts)
}

func (e *CriptoEntity) Data(args ...any) any {
...
func (e *CriptoEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Cripto; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *CriptoEntity) DataTyped(data ...Cripto) Cripto {
	if len(data) > 0 {
		return typedFrom[Cripto](e.Data(asMap(data[0])))
	}
	return typedFrom[Cripto](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Cripto (all fields
// optional at the wire level).
func (e *CriptoEntity) MatchTyped(match ...Cripto) Cripto {
	if len(match) > 0 {
		return typedFrom[Cripto](e.Match(asMap(match[0])))
	}
	return typedFrom[Cripto](e.Match())
}
...
func (e *CriptoEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *CriptoEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// CriptoLoadMatch and returns an Cripto. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *CriptoEntity) LoadTyped(reqmatch CriptoLoadMatch, ctrl map[string]any) (Cripto, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Cripto{}, err
	}
	return typedFrom[Cripto](res), nil
}



func (e *CriptoEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *CriptoEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *CriptoEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *CriptoEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *CriptoEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
