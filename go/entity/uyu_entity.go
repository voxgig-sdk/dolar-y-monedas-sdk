...
func NewUyuEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *UyuEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *UyuEntity) GetName() string { return e.name }
...
func (e *UyuEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *UyuEntity) Deleted() bool {
	return e.deleted
}


func (e *UyuEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewUyuEntity(e.client, opts)
}

func (e *UyuEntity) Data(args ...any) any {
...
func (e *UyuEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Uyu; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *UyuEntity) DataTyped(data ...Uyu) Uyu {
	if len(data) > 0 {
		return typedFrom[Uyu](e.Data(asMap(data[0])))
	}
	return typedFrom[Uyu](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Uyu (all fields
// optional at the wire level).
func (e *UyuEntity) MatchTyped(match ...Uyu) Uyu {
	if len(match) > 0 {
		return typedFrom[Uyu](e.Match(asMap(match[0])))
	}
	return typedFrom[Uyu](e.Match())
}
...
func (e *UyuEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *UyuEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// UyuLoadMatch and returns an Uyu. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *UyuEntity) LoadTyped(reqmatch UyuLoadMatch, ctrl map[string]any) (Uyu, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Uyu{}, err
	}
	return typedFrom[Uyu](res), nil
}



func (e *UyuEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *UyuEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *UyuEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *UyuEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *UyuEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
