...
func NewEurEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *EurEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EurEntity) GetName() string { return e.name }
...
func (e *EurEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EurEntity) Deleted() bool {
	return e.deleted
}


func (e *EurEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEurEntity(e.client, opts)
}

func (e *EurEntity) Data(args ...any) any {
...
func (e *EurEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Eur; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EurEntity) DataTyped(data ...Eur) Eur {
	if len(data) > 0 {
		return typedFrom[Eur](e.Data(asMap(data[0])))
	}
	return typedFrom[Eur](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Eur (all fields
// optional at the wire level).
func (e *EurEntity) MatchTyped(match ...Eur) Eur {
	if len(match) > 0 {
		return typedFrom[Eur](e.Match(asMap(match[0])))
	}
	return typedFrom[Eur](e.Match())
}
...
func (e *EurEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EurEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EurLoadMatch and returns an Eur. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *EurEntity) LoadTyped(reqmatch EurLoadMatch, ctrl map[string]any) (Eur, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Eur{}, err
	}
	return typedFrom[Eur](res), nil
}



func (e *EurEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *EurEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *EurEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EurEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EurEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
