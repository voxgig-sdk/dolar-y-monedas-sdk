...
func NewBlueEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *BlueEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BlueEntity) GetName() string { return e.name }
...
func (e *BlueEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BlueEntity) Deleted() bool {
	return e.deleted
}


func (e *BlueEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBlueEntity(e.client, opts)
}

func (e *BlueEntity) Data(args ...any) any {
...
func (e *BlueEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Blue; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BlueEntity) DataTyped(data ...Blue) Blue {
	if len(data) > 0 {
		return typedFrom[Blue](e.Data(asMap(data[0])))
	}
	return typedFrom[Blue](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Blue (all fields
// optional at the wire level).
func (e *BlueEntity) MatchTyped(match ...Blue) Blue {
	if len(match) > 0 {
		return typedFrom[Blue](e.Match(asMap(match[0])))
	}
	return typedFrom[Blue](e.Match())
}
...
func (e *BlueEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BlueEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BlueLoadMatch and returns an Blue. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BlueEntity) LoadTyped(reqmatch BlueLoadMatch, ctrl map[string]any) (Blue, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Blue{}, err
	}
	return typedFrom[Blue](res), nil
}



func (e *BlueEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BlueEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BlueEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BlueEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BlueEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
