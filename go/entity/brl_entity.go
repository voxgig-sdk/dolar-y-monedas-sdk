...
func NewBrlEntity(client *core.DolarYMonedasSDK, entopts map[string]any) *BrlEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *BrlEntity) GetName() string { return e.name }
...
func (e *BrlEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *BrlEntity) Deleted() bool {
	return e.deleted
}


func (e *BrlEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewBrlEntity(e.client, opts)
}

func (e *BrlEntity) Data(args ...any) any {
...
func (e *BrlEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Brl; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *BrlEntity) DataTyped(data ...Brl) Brl {
	if len(data) > 0 {
		return typedFrom[Brl](e.Data(asMap(data[0])))
	}
	return typedFrom[Brl](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Brl (all fields
// optional at the wire level).
func (e *BrlEntity) MatchTyped(match ...Brl) Brl {
	if len(match) > 0 {
		return typedFrom[Brl](e.Match(asMap(match[0])))
	}
	return typedFrom[Brl](e.Match())
}
...
func (e *BrlEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *BrlEntity) Load(reqmatch map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// BrlLoadMatch and returns an Brl. It delegates to the untyped
// Load (identical runtime) and converts at the typed boundary.
func (e *BrlEntity) LoadTyped(reqmatch BrlLoadMatch, ctrl map[string]any) (Brl, error) {
	res, err := e.Load(asMap(reqmatch), ctrl)
	if err != nil {
		return Brl{}, err
	}
	return typedFrom[Brl](res), nil
}



func (e *BrlEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}


func (e *BrlEntity) Create(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("create", e.name)
}


func (e *BrlEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *BrlEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *BrlEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
