...
const testSeed = `map[string]any{"entity": map[string]any{"blue": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "bolsa": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "brl": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "clp": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "contadoconliqui": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cotizacion_ambito": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cotizacione": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "cripto": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "dolare": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "estado": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "eur": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "mayorista": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "oficial": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "tarjeta": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "uyu": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
