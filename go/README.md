...
## Install
```bash
go get github.com/voxgig-sdk/dolar-y-monedas-sdk
```
...
```bash
go mod edit -replace github.com/voxgig-sdk/dolar-y-monedas-sdk=../path/to/github.com/voxgig-sdk/dolar-y-monedas-sdk
```
...
```
github.com/voxgig-sdk/dolar-y-monedas-sdk/
...
The root package (`github.com/voxgig-sdk/dolar-y-monedas-sdk`) re-exports everything needed
