...
// DolarYMonedas SDK timeout feature
...
class DolarYMonedasTimeoutFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _with_timeout(DolarYMonedasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(DolarYMonedasContext $_ctx, float $ms): void
    {
        $client = $this->client;
