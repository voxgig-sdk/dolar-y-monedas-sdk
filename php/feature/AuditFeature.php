...
// DolarYMonedas SDK audit feature
...
class DolarYMonedasAuditFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _emit(DolarYMonedasContext $ctx, string $outcome): void
    {
