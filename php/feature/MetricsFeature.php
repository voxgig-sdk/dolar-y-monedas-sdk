...
// DolarYMonedas SDK metrics feature
...
class DolarYMonedasMetricsFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _record(DolarYMonedasContext $ctx, bool $ok): void
    {
