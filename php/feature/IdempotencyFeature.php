...
// DolarYMonedas SDK idempotency feature
...
class DolarYMonedasIdempotencyFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _mutating(DolarYMonedasContext $ctx): bool
    {
