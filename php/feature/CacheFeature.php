...
// DolarYMonedas SDK cache feature
...
class DolarYMonedasCacheFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _through(DolarYMonedasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
