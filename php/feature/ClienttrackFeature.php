...
// DolarYMonedas SDK clienttrack feature
...
class DolarYMonedasClienttrackFeature extends DolarYMonedasBaseFeature
{
    ...
    public function PostConstruct(DolarYMonedasContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'DolarYMonedas-SDK';
