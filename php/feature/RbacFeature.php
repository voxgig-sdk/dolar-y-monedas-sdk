...
// DolarYMonedas SDK rbac feature
...
class DolarYMonedasRbacFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _required(DolarYMonedasContext $ctx): ?string
    {
    ...
    private function _reject(DolarYMonedasContext $ctx, string $required): void
    {
    ...
    private function _track(DolarYMonedasContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
