...
// DolarYMonedas SDK streaming feature
...
class DolarYMonedasStreamingFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _iterate(DolarYMonedasResult $result): \Generator
    {
    ...
    private function _streamable(DolarYMonedasContext $ctx): bool
    {
