...
// DolarYMonedas SDK netsim feature
...
class DolarYMonedasNetsimFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _simulate(DolarYMonedasContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(DolarYMonedasContext $ctx, array $applied): void
    {
        $client = $this->client;
