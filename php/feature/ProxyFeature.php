...
// DolarYMonedas SDK proxy feature
...
class DolarYMonedasProxyFeature extends DolarYMonedasBaseFeature
{
    ...
    public function init(DolarYMonedasContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (DolarYMonedasContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
