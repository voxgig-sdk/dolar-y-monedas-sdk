...
// DolarYMonedas SDK debug feature
...
class DolarYMonedasDebugFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _finish(DolarYMonedasContext $ctx, bool $ok): void
    {
