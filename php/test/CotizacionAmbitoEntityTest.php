...
class CotizacionAmbitoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOLAR_Y_MONEDAS_TEST_COTIZACION_AMBITO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function cotizacion_ambito_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOLAR_Y_MONEDAS_TEST_COTIZACION_AMBITO_ENTID");
