...
class CotizacioneDirectTest extends TestCase
{
    public function test_direct_list_cotizacione(): void
    {
        $setup = cotizacione_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-cotizacione", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
