...
class ClpDirectTest extends TestCase
{
    public function test_direct_load_clp(): void
    {
        $setup = clp_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-clp", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
