...
class CotizacioneEntityTest extends TestCase
{
    ...
    public function test_stream(): void
    {
        ...
        $seen = iterator_to_array($base->Cotizacione(null)->stream("list", null, null), false);
        ...
        if (isset($cfg["feature"]) && is_array($cfg["feature"]) && isset($cfg["feature"]["streaming"])) {
            ...
            $got = [];
            foreach ($sdk->Cotizacione(null)->stream("list", null, null) as $item) {
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOLAR_Y_MONEDAS_TEST_COTIZACIONE_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function cotizacione_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOLAR_Y_MONEDAS_TEST_COTIZACIONE_ENTID");
