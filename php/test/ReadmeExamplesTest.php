...
// DolarYMonedas SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (DolarYMonedasSDK::test)
...
{
    private const SDK_CLASS = 'DolarYMonedasSDK';
    ...
    private const SDK_BASE = 'dolarymonedas_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../dolarymonedas_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
