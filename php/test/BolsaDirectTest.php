...
class BolsaDirectTest extends TestCase
{
    public function test_direct_load_bolsa(): void
    {
        $setup = bolsa_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-bolsa", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
