...
class OficialDirectTest extends TestCase
{
    public function test_direct_load_oficial(): void
    {
        $setup = oficial_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-oficial", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
