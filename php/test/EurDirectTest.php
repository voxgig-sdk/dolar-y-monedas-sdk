...
class EurDirectTest extends TestCase
{
    public function test_direct_load_eur(): void
    {
        $setup = eur_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-eur", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
