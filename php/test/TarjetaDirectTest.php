...
class TarjetaDirectTest extends TestCase
{
    public function test_direct_load_tarjeta(): void
    {
        $setup = tarjeta_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-tarjeta", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
