...
class BrlDirectTest extends TestCase
{
    public function test_direct_load_brl(): void
    {
        $setup = brl_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-brl", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
