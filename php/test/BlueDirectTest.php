...
class BlueDirectTest extends TestCase
{
    public function test_direct_load_blue(): void
    {
        $setup = blue_direct_setup(["id" => "direct01"]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-load-blue", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
