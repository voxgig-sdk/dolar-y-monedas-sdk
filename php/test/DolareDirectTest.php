...
class DolareDirectTest extends TestCase
{
    public function test_direct_list_dolare(): void
    {
        $setup = dolare_direct_setup([
            ["id" => "direct01"],
            ["id" => "direct02"],
        ]);
        [$_shouldSkip, $_reason] = Runner::is_control_skipped("direct", "direct-list-dolare", $setup["live"] ? "live" : "unit");
        if ($_shouldSkip) {
