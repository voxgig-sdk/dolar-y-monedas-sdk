...
class EstadoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOLAR_Y_MONEDAS_TEST_ESTADO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function estado_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOLAR_Y_MONEDAS_TEST_ESTADO_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DOLAR_Y_MONEDAS_TEST_ESTADO_ENTID"]);
