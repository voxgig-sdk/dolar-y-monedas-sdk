...
class EstadoEntityTest extends TestCase
{
    ...
    public function test_basic_flow(): void
    {
        ...
        if (!empty($setup["synthetic_only"])) {
            $this->markTestSkipped("live entity test uses synthetic IDs from fixture — set DOLARYMONEDAS_TEST_ESTADO_ENTID JSON to run live");
            return;
        }
        $client = $setup["client"];
...
function estado_basic_setup($extra)
{
    ...
    $entid_env_raw = getenv("DOLARYMONEDAS_TEST_ESTADO_ENTID");
    ...
    $idmap_resolved = Helpers::to_map(
        $env["DOLARYMONEDAS_TEST_ESTADO_ENTID"]);
