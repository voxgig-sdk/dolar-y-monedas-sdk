...
The PHP SDK for the DolarYMonedas API. Provides an entity-oriented interface using PHP conventions.
...
```php
[$result, $err] = $client->Blue(null)->load(["id" => "example_id"], null);
...
[$result, $err] = $client->DolarYMonedas(null)->load(
    ["id" => "test01"], null
);
