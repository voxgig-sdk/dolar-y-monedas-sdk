...
// DolarYMonedas SDK utility type

class DolarYMonedasUtility
{
    ...
    public static function copy(DolarYMonedasUtility $src): DolarYMonedasUtility
    {
        $u = new DolarYMonedasUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
