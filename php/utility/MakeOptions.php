...
// DolarYMonedas SDK utility: make_options

class DolarYMonedasMakeOptions
{
    ...
    public static function call(DolarYMonedasContext $ctx): array
    {
        ...
        //
        // `DolarYMonedasSchema::optspec()` is built from the model:
        ...
        $optspec = DolarYMonedasSchema::optspec();
