...
class UyuEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new UyuEntity($this->_client, $opts);
    }

    /**
     * @param Uyu|array $args Uyu data (assoc-array) to store.
     */
    ...
    /**
     * @return Uyu|array The current Uyu data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Uyu fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Uyu fields).
     */
     ...
     * Load a single Uyu.
     *
     * @param UyuLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed UyuLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Uyu|array The loaded Uyu as an assoc-array at the
