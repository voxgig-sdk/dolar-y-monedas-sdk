...
// DolarYMonedas SDK Cotizacione entity
...
class CotizacioneEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CotizacioneEntity($this->_client, $opts);
    }

    /**
     * @param Cotizacione|array $args Cotizacione data (assoc-array) to store.
     */
    ...
    /**
     * @return Cotizacione|array The current Cotizacione data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cotizacione fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cotizacione fields).
     */
    ...
    /**
     * List Cotizacione items matching the given filter.
     *
     * @param CotizacioneListMatch|array|null $reqmatch Match filter (any subset
     *   of Cotizacione fields) as an assoc-array; CotizacioneListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cotizacione[]|array A list of Cotizacione items as assoc-arrays at
