...
class CriptoEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new CriptoEntity($this->_client, $opts);
    }

    /**
     * @param Cripto|array $args Cripto data (assoc-array) to store.
     */
    ...
    /**
     * @return Cripto|array The current Cripto data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Cripto fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Cripto fields).
     */
     ...
     *
     * @param CriptoLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed CriptoLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Cripto|array The loaded Cripto as an assoc-array at the
