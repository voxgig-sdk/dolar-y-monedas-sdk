...
// DolarYMonedas SDK Dolare entity
...
class DolareEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new DolareEntity($this->_client, $opts);
    }

    /**
     * @param Dolare|array $args Dolare data (assoc-array) to store.
     */
    ...
    /**
     * @return Dolare|array The current Dolare data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Dolare fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Dolare fields).
     */
    ...
    /**
     * List Dolare items matching the given filter.
     *
     * @param DolareListMatch|array|null $reqmatch Match filter (any subset
     *   of Dolare fields) as an assoc-array; DolareListMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Dolare[]|array A list of Dolare items as assoc-arrays at
