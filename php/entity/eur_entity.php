...
class EurEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new EurEntity($this->_client, $opts);
    }

    /**
     * @param Eur|array $args Eur data (assoc-array) to store.
     */
    ...
    /**
     * @return Eur|array The current Eur data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Eur fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Eur fields).
     */
     ...
     * Load a single Eur.
     *
     * @param EurLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed EurLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Eur|array The loaded Eur as an assoc-array at the
