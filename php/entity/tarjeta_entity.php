...
// DolarYMonedas SDK Tarjeta entity
...
class TarjetaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new TarjetaEntity($this->_client, $opts);
    }

    /**
     * @param Tarjeta|array $args Tarjeta data (assoc-array) to store.
     */
    ...
    /**
     * @return Tarjeta|array The current Tarjeta data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Tarjeta fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Tarjeta fields).
     */
    ...
    /**
     * Load a single Tarjeta.
     *
     * @param TarjetaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed TarjetaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Tarjeta|array The loaded Tarjeta as an assoc-array at the
