...
class BlueEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BlueEntity($this->_client, $opts);
    }

    /**
     * @param Blue|array $args Blue data (assoc-array) to store.
     */
    ...
    /**
     * @return Blue|array The current Blue data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Blue fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Blue fields).
     */
     ...
     * Load a single Blue.
     *
     * @param BlueLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BlueLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Blue|array The loaded Blue as an assoc-array at the
