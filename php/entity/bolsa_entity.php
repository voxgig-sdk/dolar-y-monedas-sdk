...
// DolarYMonedas SDK Bolsa entity
...
class BolsaEntity
{
    ...
    {
        $opts = $this->_entopts;
        return new BolsaEntity($this->_client, $opts);
    }

    /**
     * @param Bolsa|array $args Bolsa data (assoc-array) to store.
     */
    ...
    /**
     * @return Bolsa|array The current Bolsa data as an assoc-array.
     */
    ...
    /**
     * @param array $args Match filter (any subset of Bolsa fields).
     */
    ...
    /**
     * @return array The current match filter (any subset of Bolsa fields).
     */
     ...
     * Load a single Bolsa.
     *
     * @param BolsaLoadMatch|array|null $reqmatch Match criteria (id/query
     *   fields) as an assoc-array; a typed BolsaLoadMatch names the shape.
     * @param mixed $ctrl Optional per-call control overrides.
     * @return Bolsa|array The loaded Bolsa as an assoc-array at the
