...
| --- | --- | --- |
| TypeScript | `@voxgig-sdk/dolar-y-monedas` | `npm install @voxgig-sdk/dolar-y-monedas` |
| Python | `voxgig-sdk-dolar-y-monedas` | `pip install voxgig-sdk-dolar-y-monedas` |
| PHP | `voxgig-sdk/dolar-y-monedas` | `composer require voxgig-sdk/dolar-y-monedas` |
| Golang | `github.com/voxgig-sdk/dolar-y-monedas-sdk/go` | `go get github.com/voxgig-sdk/dolar-y-monedas-sdk/go` |
| Ruby | `voxgig-sdk-dolar-y-monedas` | `gem install voxgig-sdk-dolar-y-monedas` |
| Lua | `voxgig-sdk-dolar-y-monedas` | `luarocks install voxgig-sdk-dolar-y-monedas` |
