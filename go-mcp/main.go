// Command DolarYMonedas-mcp is an MCP server exposing the DolarYMonedas
// SDK as MCP tools.
//
// Two tools are registered:
//
//	DolarYMonedas_list  — list records of an entity
//	DolarYMonedas_load  — load a single record of an entity
//
