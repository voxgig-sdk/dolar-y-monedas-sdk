...
|---|---|---|
| `ts/` | @voxgig-sdk/dolar-y-monedas-sdk | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/dolar-y-monedas-sdk \
      --repository voxgig-sdk/dolar-y-monedas-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/dolar-y-monedas-sdk` shows it, and
`npm trust revoke @voxgig-sdk/dolar-y-monedas-sdk --id=<id>` removes it.
