...
// DolarYMonedas SDK utility: fetcher

class DolarYMonedasFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; DolarYMonedasSDK/1.0)';
    ...
    public static function call(DolarYMonedasContext $ctx, string $fullurl, array $fetchdef): array
    {
