...
// DolarYMonedas SDK utility: graphql
//
...
class DolarYMonedasGraphql
{
    ...
    // equivalent.
    public static function body(DolarYMonedasContext $ctx): mixed
    {
    ...
    public static function errors(DolarYMonedasContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
