...
// DolarYMonedas SDK struct utility test
//
...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = DolarYMonedasOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(DolarYMonedasOmni::structfix($now, Struct::undef()))
                        !== json_encode(DolarYMonedasOmni::structfix($val, Struct::undef()))) {
