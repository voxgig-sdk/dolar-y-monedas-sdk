...
// DolarYMonedas SDK ratelimit feature
...
class DolarYMonedasRatelimitFeature extends DolarYMonedasBaseFeature
{
    ...
    private function _acquire(DolarYMonedasContext $ctx): void
    {
    ...
    private function _track(DolarYMonedasContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
