...
local BolsaEntity = {}
BolsaEntity.__index = BolsaEntity


function BolsaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, BolsaEntity)
  self._name = "bolsa"
  self._client = client
...
function BolsaEntity:get_name()
  return self._name
end


function BolsaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return BolsaEntity.new(self._client, opts)
end
...
function BolsaEntity:mark_deleted()
  self._deleted = true
end


function BolsaEntity:deleted()
  return true == self._deleted
end


function BolsaEntity:data_set(args)
  if args ~= nil then
...
function BolsaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function BolsaEntity:match_set(args)
  if args ~= nil then
...
function BolsaEntity:match_get()
...
function BolsaEntity:stream(action, args, callopts)
...
---@param reqmatch BolsaLoadMatch
---@param ctrl? table
---@return Bolsa
---@return string? err
function BolsaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function BolsaEntity:_run_op(ctx, post_done)
  local utility = self._utility
