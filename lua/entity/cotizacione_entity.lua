...
local CotizacioneEntity = {}
CotizacioneEntity.__index = CotizacioneEntity


function CotizacioneEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CotizacioneEntity)
  self._name = "cotizacione"
  self._client = client
...
function CotizacioneEntity:get_name()
  return self._name
end


function CotizacioneEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CotizacioneEntity.new(self._client, opts)
end
...
function CotizacioneEntity:mark_deleted()
  self._deleted = true
end


function CotizacioneEntity:deleted()
  return true == self._deleted
end


function CotizacioneEntity:data_set(args)
  if args ~= nil then
...
function CotizacioneEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CotizacioneEntity:match_set(args)
  if args ~= nil then
...
function CotizacioneEntity:match_get()
...
function CotizacioneEntity:stream(action, args, callopts)
...
---@param reqmatch CotizacioneListMatch
---@param ctrl? table
---@return Cotizacione[]
---@return string? err
function CotizacioneEntity:list(reqmatch, ctrl)
  local utility = self._utility
...
function CotizacioneEntity:_run_op(ctx, post_done)
  local utility = self._utility
