...
local TarjetaEntity = {}
TarjetaEntity.__index = TarjetaEntity


function TarjetaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, TarjetaEntity)
  self._name = "tarjeta"
  self._client = client
...
function TarjetaEntity:get_name()
  return self._name
end


function TarjetaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return TarjetaEntity.new(self._client, opts)
end
...
function TarjetaEntity:mark_deleted()
  self._deleted = true
end


function TarjetaEntity:deleted()
  return true == self._deleted
end


function TarjetaEntity:data_set(args)
  if args ~= nil then
...
function TarjetaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function TarjetaEntity:match_set(args)
  if args ~= nil then
...
function TarjetaEntity:match_get()
...
function TarjetaEntity:stream(action, args, callopts)
...
---@param reqmatch TarjetaLoadMatch
---@param ctrl? table
---@return Tarjeta
---@return string? err
function TarjetaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function TarjetaEntity:_run_op(ctx, post_done)
  local utility = self._utility
