...
local OficialEntity = {}
OficialEntity.__index = OficialEntity


function OficialEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, OficialEntity)
  self._name = "oficial"
  self._client = client
...
function OficialEntity:get_name()
  return self._name
end


function OficialEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return OficialEntity.new(self._client, opts)
end
...
function OficialEntity:mark_deleted()
  self._deleted = true
end


function OficialEntity:deleted()
  return true == self._deleted
end


function OficialEntity:data_set(args)
  if args ~= nil then
...
function OficialEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function OficialEntity:match_set(args)
  if args ~= nil then
...
function OficialEntity:match_get()
...
function OficialEntity:stream(action, args, callopts)
...
function OficialEntity:_run_op(ctx, post_done)
  local utility = self._utility
