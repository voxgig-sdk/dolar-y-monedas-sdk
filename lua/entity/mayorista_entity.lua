...
local MayoristaEntity = {}
MayoristaEntity.__index = MayoristaEntity


function MayoristaEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, MayoristaEntity)
  self._name = "mayorista"
  self._client = client
...
function MayoristaEntity:get_name()
  return self._name
end


function MayoristaEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return MayoristaEntity.new(self._client, opts)
end
...
function MayoristaEntity:mark_deleted()
  self._deleted = true
end


function MayoristaEntity:deleted()
  return true == self._deleted
end


function MayoristaEntity:data_set(args)
  if args ~= nil then
...
function MayoristaEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function MayoristaEntity:match_set(args)
  if args ~= nil then
...
function MayoristaEntity:match_get()
...
function MayoristaEntity:stream(action, args, callopts)
...
---@param reqmatch MayoristaLoadMatch
---@param ctrl? table
---@return Mayorista
---@return string? err
function MayoristaEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function MayoristaEntity:_run_op(ctx, post_done)
  local utility = self._utility
