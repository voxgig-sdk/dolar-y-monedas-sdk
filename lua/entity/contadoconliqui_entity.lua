...
local ContadoconliquiEntity = {}
ContadoconliquiEntity.__index = ContadoconliquiEntity


function ContadoconliquiEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, ContadoconliquiEntity)
  self._name = "contadoconliqui"
  self._client = client
...
function ContadoconliquiEntity:get_name()
  return self._name
end


function ContadoconliquiEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return ContadoconliquiEntity.new(self._client, opts)
end
...
function ContadoconliquiEntity:mark_deleted()
  self._deleted = true
end


function ContadoconliquiEntity:deleted()
  return true == self._deleted
end


function ContadoconliquiEntity:data_set(args)
  if args ~= nil then
...
function ContadoconliquiEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function ContadoconliquiEntity:match_set(args)
  if args ~= nil then
...
function ContadoconliquiEntity:match_get()
...
function ContadoconliquiEntity:stream(action, args, callopts)
...
---@param reqmatch ContadoconliquiLoadMatch
---@param ctrl? table
---@return Contadoconliqui
---@return string? err
function ContadoconliquiEntity:load(reqmatch, ctrl)
  local utility = self._utility
...
function ContadoconliquiEntity:_run_op(ctx, post_done)
  local utility = self._utility
