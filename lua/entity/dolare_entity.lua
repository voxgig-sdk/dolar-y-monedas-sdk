...
local DolareEntity = {}
DolareEntity.__index = DolareEntity


function DolareEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, DolareEntity)
  self._name = "dolare"
  self._client = client
...
function DolareEntity:get_name()
  return self._name
end


function DolareEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return DolareEntity.new(self._client, opts)
end
...
function DolareEntity:mark_deleted()
  self._deleted = true
end


function DolareEntity:deleted()
  return true == self._deleted
end


function DolareEntity:data_set(args)
  if args ~= nil then
...
function DolareEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function DolareEntity:match_set(args)
  if args ~= nil then
...
function DolareEntity:match_get()
...
function DolareEntity:stream(action, args, callopts)
...
function DolareEntity:_run_op(ctx, post_done)
  local utility = self._utility
