...
local CotizacionAmbitoEntity = {}
CotizacionAmbitoEntity.__index = CotizacionAmbitoEntity


function CotizacionAmbitoEntity.new(client, entopts)
  entopts = entopts or {}
  ...
  local self = setmetatable({}, CotizacionAmbitoEntity)
  self._name = "cotizacion_ambito"
  self._client = client
...
function CotizacionAmbitoEntity:get_name()
  return self._name
end


function CotizacionAmbitoEntity:make()
  local opts = {}
  for k, v in pairs(self._entopts) do
    opts[k] = v
  end
  return CotizacionAmbitoEntity.new(self._client, opts)
end
...
function CotizacionAmbitoEntity:mark_deleted()
  self._deleted = true
end


function CotizacionAmbitoEntity:deleted()
  return true == self._deleted
end


function CotizacionAmbitoEntity:data_set(args)
  if args ~= nil then
...
function CotizacionAmbitoEntity:data_get()
  self._utility.feature_hook(self._entctx, "GetData")
  return vs.clone(self._data)
end


function CotizacionAmbitoEntity:match_set(args)
  if args ~= nil then
...
function CotizacionAmbitoEntity:match_get()
...
function CotizacionAmbitoEntity:stream(action, args, callopts)
...
function CotizacionAmbitoEntity:_run_op(ctx, post_done)
  local utility = self._utility
