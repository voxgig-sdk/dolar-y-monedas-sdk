...
describe("OficialDirect", function()
  it("should direct-load-oficial", function()
    local setup = oficial_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-oficial", setup.live and "live" or "unit")
...
function oficial_direct_setup(mockres)
