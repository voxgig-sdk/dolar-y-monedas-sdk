...
describe("BrlDirect", function()
  it("should direct-load-brl", function()
    local setup = brl_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-brl", setup.live and "live" or "unit")
...
function brl_direct_setup(mockres)
