...
describe("MayoristaDirect", function()
  it("should direct-load-mayorista", function()
    local setup = mayorista_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-mayorista", setup.live and "live" or "unit")
...
function mayorista_direct_setup(mockres)
