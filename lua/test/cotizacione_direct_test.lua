...
describe("CotizacioneDirect", function()
  it("should direct-list-cotizacione", function()
    local setup = cotizacione_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cotizacione", setup.live and "live" or "unit")
...
function cotizacione_direct_setup(mockres)
