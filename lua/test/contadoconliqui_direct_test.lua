...
describe("ContadoconliquiDirect", function()
  it("should direct-load-contadoconliqui", function()
    local setup = contadoconliqui_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-contadoconliqui", setup.live and "live" or "unit")
...
function contadoconliqui_direct_setup(mockres)
