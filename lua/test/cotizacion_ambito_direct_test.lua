...
describe("CotizacionAmbitoDirect", function()
  it("should direct-list-cotizacion_ambito", function()
    local setup = cotizacion_ambito_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-cotizacion_ambito", setup.live and "live" or "unit")
  ...
  it("should direct-load-cotizacion_ambito", function()
    local setup = cotizacion_ambito_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cotizacion_ambito", setup.live and "live" or "unit")
    if _should_skip then
      pending(_reason or "skipped via sdk-test-control.json")
      return
    end
...
function cotizacion_ambito_direct_setup(mockres)
