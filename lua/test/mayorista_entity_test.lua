...
describe("MayoristaEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DOLAR_Y_MONEDAS_TEST_MAYORISTA_ENTID JSON to run live")
      return
    end
...
function mayorista_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DOLAR_Y_MONEDAS_TEST_MAYORISTA_ENTID")
