...
describe("ClpDirect", function()
  it("should direct-load-clp", function()
    local setup = clp_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-clp", setup.live and "live" or "unit")
...
function clp_direct_setup(mockres)
