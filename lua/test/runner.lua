...
function runner.env_override(m)
  local live = runner.getenv("DOLARYMONEDAS_TEST_LIVE")
  local override = runner.getenv("DOLARYMONEDAS_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("DOLARYMONEDAS_TEST_EXPLAIN")
