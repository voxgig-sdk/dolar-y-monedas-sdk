...
describe("UyuDirect", function()
  it("should direct-load-uyu", function()
    local setup = uyu_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-uyu", setup.live and "live" or "unit")
...
function uyu_direct_setup(mockres)
