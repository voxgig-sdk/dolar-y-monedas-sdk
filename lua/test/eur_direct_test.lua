...
describe("EurDirect", function()
  it("should direct-load-eur", function()
    local setup = eur_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-eur", setup.live and "live" or "unit")
...
function eur_direct_setup(mockres)
