...
describe("CriptoDirect", function()
  it("should direct-load-cripto", function()
    local setup = cripto_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-cripto", setup.live and "live" or "unit")
...
function cripto_direct_setup(mockres)
