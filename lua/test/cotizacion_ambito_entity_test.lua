...
describe("CotizacionAmbitoEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set DOLARYMONEDAS_TEST_COTIZACION_AMBITO_ENTID JSON to run live")
      return
    end
...
function cotizacion_ambito_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("DOLARYMONEDAS_TEST_COTIZACION_AMBITO_ENTID")
