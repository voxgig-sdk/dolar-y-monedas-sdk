...
describe("DolareDirect", function()
  it("should direct-list-dolare", function()
    local setup = dolare_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-dolare", setup.live and "live" or "unit")
...
function dolare_direct_setup(mockres)
