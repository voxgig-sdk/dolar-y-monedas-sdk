...
describe("BolsaDirect", function()
  it("should direct-load-bolsa", function()
    local setup = bolsa_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-bolsa", setup.live and "live" or "unit")
...
function bolsa_direct_setup(mockres)
