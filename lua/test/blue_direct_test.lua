...
describe("BlueDirect", function()
  it("should direct-load-blue", function()
    local setup = blue_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-blue", setup.live and "live" or "unit")
...
function blue_direct_setup(mockres)
