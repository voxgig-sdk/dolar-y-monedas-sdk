...
describe("TarjetaDirect", function()
  it("should direct-load-tarjeta", function()
    local setup = tarjeta_direct_setup({ id = "direct01" })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-load-tarjeta", setup.live and "live" or "unit")
...
function tarjeta_direct_setup(mockres)
