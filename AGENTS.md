...
**Entities** (15): `Blue`, `Bolsa`, `Brl`, `Clp`, `Contadoconliqui`, `CotizacionAmbito`, `Cotizacione`, `Cripto`, `Dolare`, `Estado`, `Eur`, `Mayorista`, `Oficial`, `Tarjeta`, `Uyu`.
