...
(0, node_test_1.describe)('CriptoEntity', async () => {
    ...
    (0, node_test_1.test)('basic', async (t) => {
        ...
        for (const op of ['load']) {
            if ((0, utility_1.maybeSkipControl)(t, 'entityOp', 'cripto.' + op, live))
                return;
        }
        ...
        let cripto_ref01_data = Object.values(setup.data.existing.cripto)[0];
        // LOAD
        const cripto_ref01_ent = client.Cripto();
        const cripto_ref01_match_dt0 = {};
        const cripto_ref01_data_dt0 = (await cripto_ref01_ent.load(cripto_ref01_match_dt0)).data();
        (0, node_assert_1.default)(null != cripto_ref01_data_dt0);
    });
});
function basicSetup(extra) {
    ...
    const entityDataFile = node_path_1.default.resolve(__dirname, '../../../../.sdk/test/entity/cripto/CriptoTestData.json');
    ...
    let idmap = transform(['cripto01', 'cripto02', 'cripto03'], {
        '`$PACK`': ['', {
                '`$KEY`': '`$COPY`',
    ...
    const idmapEnvVal = process.env['DOLAR_Y_MONEDAS_TEST_CRIPTO_ENTID'];
...
//# sourceMappingURL=CriptoEntity.test.js.map