...
(0, node_test_1.describe)('TarjetaDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-tarjeta', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-tarjeta', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DOLAR_Y_MONEDAS_TEST_TARJETA_ENTID'];
...
//# sourceMappingURL=TarjetaDirect.test.js.map