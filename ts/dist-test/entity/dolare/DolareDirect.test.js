...
(0, node_test_1.describe)('DolareDirect', async () => {
    ...
    (0, node_test_1.test)('direct-list-dolare', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup([{ id: 'direct01' }, { id: 'direct02' }]);
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-list-dolare', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DOLAR_Y_MONEDAS_TEST_DOLARE_ENTID'];
...
//# sourceMappingURL=DolareDirect.test.js.map