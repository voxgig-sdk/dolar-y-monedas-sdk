...
(0, node_test_1.describe)('OficialDirect', async () => {
    ...
    (0, node_test_1.test)('direct-load-oficial', async (t) => {
        if (liveScenariosActive()) {
            t.skip('Covered by live operation scenarios');
            return;
        }
        const setup = directSetup({ id: 'direct01' });
        if ((0, utility_1.maybeSkipControl)(t, 'direct', 'direct-load-oficial', setup.live))
            return;
...
function directSetup(mockres) {
    ...
    if (live) {
        ...
        let idmap = env['DOLAR_Y_MONEDAS_TEST_OFICIAL_ENTID'];
...
//# sourceMappingURL=OficialDirect.test.js.map