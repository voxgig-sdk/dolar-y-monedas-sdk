...
function envOverride(m) {
    if ('TRUE' === process.env.DOLAR_Y_MONEDAS_TEST_LIVE ||
        'TRUE' === process.env.DOLAR_Y_MONEDAS_TEST_OVERRIDE) {
    ...
    m.DOLAR_Y_MONEDAS_TEST_EXPLAIN = process.env.DOLAR_Y_MONEDAS_TEST_EXPLAIN || m.DOLAR_Y_MONEDAS_TEST_EXPLAIN;
    return m;
}
