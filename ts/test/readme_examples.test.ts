...
//     (\`new DolarYMonedasSDK(...)\` / \`DolarYMonedasSDK.test(...)\` become
//     \`DolarYMonedasSDK.test({ entity: ... })\`), transpiled to JS, and run
...
const SDK_NAME = 'DolarYMonedasSDK'
...
const TEST_SEED = {"entity":{"blue":{"test01":{"id":"test01"}},"bolsa":{"test01":{"id":"test01"}},"brl":{"test01":{"id":"test01"}},"clp":{"test01":{"id":"test01"}},"contadoconliqui":{"test01":{"id":"test01"}},"cotizacion_ambito":{"test01":{"id":"test01"}},"cotizacione":{"test01":{"id":"test01"}},"cripto":{"test01":{"id":"test01"}},"dolare":{"test01":{"id":"test01"}},"estado":{"test01":{"id":"test01"}},"eur":{"test01":{"id":"test01"}},"mayorista":{"test01":{"id":"test01"}},"oficial":{"test01":{"id":"test01"}},"tarjeta":{"test01":{"id":"test01"}},"uyu":{"test01":{"id":"test01"}}}}
...
// rewrite real client construction (\`new DolarYMonedasSDK(...)\` and any
// \`DolarYMonedasSDK.test(...)\`) to a seeded test-mode client, and give
...
function rewriteForRun(code: string): string {
  ...
  out = out.replace(/new\s+DolarYMonedasSDK\s*\([^)]*\)/g, () => SEEDED_CTOR)
  out = out.replace(/DolarYMonedasSDK\.test\s*\([^)]*\)/g, () => SEEDED_CTOR)
