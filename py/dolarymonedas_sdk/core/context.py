...
from dolarymonedas_sdk.core.helpers import get_ctx_prop, to_map
...
class DolarYMonedasContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = DolarYMonedasControl()
        ...
        if isinstance(sp, DolarYMonedasSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, DolarYMonedasResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, DolarYMonedasResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return DolarYMonedasError(code, msg, self)
