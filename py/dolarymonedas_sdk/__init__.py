...
from dolarymonedas_sdk.utility import register

# Load features
from dolarymonedas_sdk.feature.base_feature import DolarYMonedasBaseFeature
from dolarymonedas_sdk.features import _has_feature, _make_feature
...
class DolarYMonedasSDK:
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("DolarYMonedasSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Contadoconliqui(self, data=None) -> "ContadoconliquiEntity":
        ...
        from dolarymonedas_sdk.entity.contadoconliqui_entity import ContadoconliquiEntity
    ...
    def CotizacionAmbito(self, data=None) -> "CotizacionAmbitoEntity":
        ...
        from dolarymonedas_sdk.entity.cotizacion_ambito_entity import CotizacionAmbitoEntity
    ...
    def Cotizacione(self, data=None) -> "CotizacioneEntity":
        ...
        from dolarymonedas_sdk.entity.cotizacione_entity import CotizacioneEntity
    ...
    def Cripto(self, data=None) -> "CriptoEntity":
        ...
        from dolarymonedas_sdk.entity.cripto_entity import CriptoEntity
    ...
    def Dolare(self, data=None) -> "DolareEntity":
        ...
        from dolarymonedas_sdk.entity.dolare_entity import DolareEntity
    ...
    def Estado(self, data=None) -> "EstadoEntity":
        ...
        from dolarymonedas_sdk.entity.estado_entity import EstadoEntity
        return EstadoEntity(self, data)


    def Eur(self, data=None) -> "EurEntity":
        """Entity factory: client.Eur().list() / client.Eur().load({"id": ...})."""
        from dolarymonedas_sdk.entity.eur_entity import EurEntity
    ...
    def Mayorista(self, data=None) -> "MayoristaEntity":
        ...
        from dolarymonedas_sdk.entity.mayorista_entity import MayoristaEntity
    ...
    def Oficial(self, data=None) -> "OficialEntity":
        ...
        from dolarymonedas_sdk.entity.oficial_entity import OficialEntity
    ...
    def Tarjeta(self, data=None) -> "TarjetaEntity":
        ...
        from dolarymonedas_sdk.entity.tarjeta_entity import TarjetaEntity
        return TarjetaEntity(self, data)


    def Uyu(self, data=None) -> "UyuEntity":
        """Entity factory: client.Uyu().list() / client.Uyu().load({"id": ...})."""
        from dolarymonedas_sdk.entity.uyu_entity import UyuEntity
