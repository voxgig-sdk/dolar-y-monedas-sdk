...
class ContadoconliquiEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return ContadoconliquiEntity(self._client, opts)
    ...
    def data_get(self) -> Contadoconliqui:
    ...
    def match_get(self) -> Contadoconliqui:
    ...
    def load(self, reqmatch=None, ctrl=None) -> Contadoconliqui:
        utility = self._utility
        # reqmatch is optional: an entity with no id-like key loads with no
        # match. Treat None as an empty match so client.Contadoconliqui().load()
        # works with no args.
        if reqmatch is None:
            reqmatch = {}
