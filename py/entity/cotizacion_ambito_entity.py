...
class CotizacionAmbitoEntity:
    ...
    def load(self, reqmatch: CotizacionAmbitoLoadMatch, ctrl=None) -> CotizacionAmbito:
    ...
    def list(self, reqmatch: CotizacionAmbitoListMatch, ctrl=None) -> list[CotizacionAmbito]:
        utility = self._utility
        ctx = utility.make_context({
            "opname": "list",
            "ctrl": ctrl,
