# DolarYMonedas SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions DolarYMonedasSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both DolarYMonedasSDK(...) and DolarYMonedasSDK.test(...) become
#      DolarYMonedasSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "dolarymonedas_sdk"
_SDK_CLASS = "DolarYMonedasSDK"
...
_ENTITIES = {
    ...
    "CotizacionAmbito": "cotizacion_ambito",
