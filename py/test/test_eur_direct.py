...
class TestEurDirect:
    ...
    def test_should_direct_load_eur(self):
        setup = _eur_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-eur", "live" if setup["live"] else "unit")
        if _skip:
