...
class TestUyuDirect:
    ...
    def test_should_direct_load_uyu(self):
        setup = _uyu_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-uyu", "live" if setup["live"] else "unit")
        if _skip:
