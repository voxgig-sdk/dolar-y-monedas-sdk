...
class TestBrlDirect:
    ...
    def test_should_direct_load_brl(self):
        setup = _brl_direct_setup({"id": "direct01"})
        _skip, _reason = runner.is_control_skipped("direct", "direct-load-brl", "live" if setup["live"] else "unit")
        if _skip:
