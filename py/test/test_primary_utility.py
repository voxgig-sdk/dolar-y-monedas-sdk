...
_runner = makeRunner(TEST_JSON_FILE, DolarYMonedasSDK.test(None, None))
...
class TestPrimaryUtility:
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = DolarYMonedasSDK.test(None, setup.get('a') or {})
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = DolarYMonedasSDK.test(None, setup.get('a') or {})
